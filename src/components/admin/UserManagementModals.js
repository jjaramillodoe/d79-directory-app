...
export default function UserManagementModals({
  ...
  return (
      <div className="legacy-ui">
        ...
        {showModal && (
          <Modal onClose={() => onCloseModal()} labelledBy="user-form-title">
                      ...
                      <div className="space-y-3">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">User Level</label>
                             ...
                             value={user.level}
                             onChange={(e) => onPermissionUpdate(user._id, { level: parseInt(e.target.value) })}
                           >
                             <option value={1}>Level 1 - Viewer (Can only view forms they're assigned to)</option>
                             <option value={2}>Level 2 - Other Titles (Can view and edit forms from their school)</option>
                             <option value={3}>Level 3 - Assistant Principal (Can view and edit forms they're assigned to)</option>
                           ...
                           <input
                             ...
                             onBlur={(e) => {
                               ...
                               if (next !== (user.title || '')) {
                                 onPermissionUpdate(user._id, { title: next });
                               }
                             }}
                         ...
                         <div className="flex items-center">
                           <input
                             ...
                             onChange={(e) => onPermissionUpdate(user._id, { isActive: e.target.checked })}
                           />
        ...
        {/* Bulk Actions Modal */}
        {showBulkModal && (
          <Modal onClose={() => onCloseBulk()} labelledBy="bulk-users-title">
        ...
        {/* Audit Log Modal */}
        {showAuditModal && (
          <Modal onClose={() => onCloseAudit()} size="full" labelledBy="audit-log-title">
         ...
         {/* CSV Import Modal */}
         {showCsvImportModal && (
           <Modal onClose={onCloseCsv} size="xl" labelledBy="csv-import-title">
