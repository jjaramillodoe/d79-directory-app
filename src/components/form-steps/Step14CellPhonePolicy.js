...
const Step14CellPhonePolicy = ({ stepData, updateStepData, isActive, currentStep }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-lg font-bold text-blue-800">Policy Guidelines</span>
          </div>
          <p className="text-blue-700 leading-relaxed">
            This step establishes clear cell phone usage policies that balance student needs with educational focus and classroom management.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-lg font-bold text-blue-800">Implementation</span>
          </div>
          <p className="text-blue-700 leading-relaxed">
            Ensure all stakeholders understand the policy and procedures are consistently enforced across the school.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 shadow-lg">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-xl font-bold text-white">Clear Policy Implementation</span>
        </div>
        <p className="text-blue-50 leading-relaxed">
          A clear cell phone policy helps maintain focus on learning while respecting student needs. Ensure all stakeholders understand the policy and procedures are consistently applied throughout the school.
        </p>
      </div>
    </div>
  );
