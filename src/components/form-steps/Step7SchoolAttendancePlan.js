...
const Step7SchoolAttendancePlan = ({ stepData, updateStepData, isActive, currentStep }) => {
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-bold text-white mb-2">
              Section 6: School Attendance Plan
            </h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mt-6 space-y-4">
          <div className="text-white space-y-3">
            <p className="leading-relaxed">
              <a 
                href="https://www.schools.nyc.gov/docs/default-source/default-document-library/a-210-english" 
                target="_blank" 
              ...
              |{' '}
              <a 
                href="https://infohub.nyced.org/nyc-doe-topics/Policies/attendance/nyc-attendance-policy" 
                target="_blank" 
                rel="noopener noreferrer"
                className="underline hover:text-blue-100 transition-colors font-semibold"
              >
                Info Hub: Attendance Section
              </a>
            </p>
            
            <p className="leading-relaxed">
              The School Attendance Plan should reflect the manner in which the school will meet the standards of attendance as set forth in Chancellor's Regulations, state guidance and as described in school-defined attendance policies.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-lg font-bold text-blue-800">Attendance Monitoring</span>
          </div>
          <p className="text-blue-700 leading-relaxed">
            This step establishes comprehensive protocols for attendance monitoring and intervention strategies to improve student attendance and academic success.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-yellow-400 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-lg font-bold text-yellow-800">Intervention Strategies</span>
          </div>
          <p className="text-yellow-800 leading-relaxed">
            Ensure all required fields are completed and intervention protocols are clearly documented for effective attendance improvement.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 shadow-lg">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-xl font-bold text-white">Attendance Excellence</span>
        </div>
        <p className="text-blue-50 leading-relaxed">
          Effective attendance monitoring and intervention are essential for student success. Ensure all protocols are clearly documented and staff are properly trained to implement the required procedures.
        </p>
      </div>
    </div>
  );
