...
const Step10PlanningInterviews = ({ stepData, updateStepData, isActive, currentStep }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-lg font-bold text-blue-800">Student Planning</span>
          </div>
          <p className="text-blue-700 leading-relaxed">
            This step establishes protocols for coordinating student planning interviews to support academic and career development.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-yellow-400 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-lg font-bold text-yellow-800">Coordination Process</span>
          </div>
          <p className="text-yellow-800 leading-relaxed">
            Ensure all planning interview procedures are clearly documented and accessible to students and families.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 shadow-lg">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-xl font-bold text-white">Student Success Planning</span>
        </div>
        <p className="text-blue-50 leading-relaxed">
          Planning interviews are essential for student academic and career success. Ensure all procedures are clearly documented and staff are properly trained to provide effective guidance and support.
        </p>
      </div>
    </div>
  );
