...
| 5 | Super Admin | All schools, [school catalog](/features/schools), question bank, rollover, goals, comments, ownership transfer, bulk import, System, [role preview](/features/role-preview) |

{/* Screenshot needed: Dashboard by role — Super Admin sidebar (Forms, Users, Schools, Goals, Question bank, System, Audit logs, Year setup) versus a principal sidebar. */}
...
- Super Admin (level 5) may list and update **every other account**, including other Super Admins, and may assign levels 1–5
- Below Super Admin, actor level must be **strictly higher** than the target
