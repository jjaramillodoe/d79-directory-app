...
| `/admin/schools` | Super Admin | [School catalog](/features/schools): create, rename, and deactivate schools |
...
| `src/lib/branding.js` | Product name (`APP_NAME`) for tabs, headers, and exports |
| `src/lib/populateFormFromBank.js` | Super Admin seed empty shells or filled answers onto a plan |
