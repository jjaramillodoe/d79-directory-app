...
![System architecture](https://placehold.co/600x400)
*Caption: Add diagram showing browser → Next.js App Router → NextAuth/Google → API routes → Mongoose → MongoDB, with optional Redis for step locks, cache, and save rate limits.*
