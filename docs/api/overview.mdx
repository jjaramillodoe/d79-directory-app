...
<AccordionGroup>
  <Accordion title="Public and auth">
    ...
    - `POST` `/api/client-errors` — unauthenticated browser error sink (10 / 5 min per IP; no session so a broken login page can still report)
  ...
  <Accordion title="Admin">
    Question bank, school catalog, populate-bank, contact-table migrate, rollover, live override, year CSV, goals, reports, timeline, health — [Admin API](/api/admin) and [System health](/features/system).
  </Accordion>
