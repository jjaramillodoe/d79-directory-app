...
The app is a standard Next.js project (`package.json` name `d79-directory`). Runtime is **Node.js 22** (`engines.node` and `.nvmrc`). Vercel is retiring Node 20; do not pin the project back to 20.
...
{/* Screenshot needed: Vercel deployment — a successful Vercel production deployment for d79-directory-app. */}
