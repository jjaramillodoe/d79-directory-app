...
<CardGroup cols={2}>
  ...
  <Card title="School catalog" icon="school" href="/features/schools">
    Super Admin list of schools for new plans and user dropdowns.
  </Card>
  <Card title="Data models" icon="database" href="/database/models">
    Mongoose schemas for users, schools, plans, question bank, comments, and audit logs.
  </Card>
...
- Super Admins maintain a **[school catalog](/features/schools)** used by new-plan and user dropdowns.
...
<Callout type="warning">
  Super Admin (level 5) is the only role that can publish the question bank, run year rollover, manage the [school catalog](/features/schools), manage district-wide submissions/goals, add review comments, and open System health.
</Callout>
