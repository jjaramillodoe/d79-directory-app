---
title: Quickstart
description: Install, configure, seed, and run the Consolidated School & Youth Development Plan locally.
icon: rocket
---
...
{/* Screenshot needed: Login screen — the Google sign-in card and the @schools.nyc.gov restriction notice. */}
...
| `node src/scripts/populate-form-from-bank.js` | Super Admin seed: empty shells or `--answers` sample responses (`--apply --force` to write) |
